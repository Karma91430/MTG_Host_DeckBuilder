    ...
    <html lang="fr">
      <body className="min-h-screen">
        <header className="border-b border-bordure bg-panneau">
          <div className="mx-auto flex w-[90%] items-center gap-6 px-6 py-3">
            ...
            <nav className="flex gap-4 text-sm text-attenue">
              ...
              <Link href="/comparer" className="hover:text-texte">Comparer</Link>
            </nav>
        ...
        <main className="mx-auto w-[90%] px-6 py-6">{children}</main>
      </body>
    </html>
  );
}
